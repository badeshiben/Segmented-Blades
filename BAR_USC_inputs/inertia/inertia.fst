...
---------------------- INPUT FILES ---------------------------------------------
"BAR_USC_ElastoDyn_inertia.dat" EDFile        - Name of file containing ElastoDyn input parameters (quoted string)
"BAR_USC_BeamDyn_inertia.dat" BDBldFile(1)  - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
