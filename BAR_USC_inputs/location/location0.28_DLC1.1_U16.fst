...
---------------------- INPUT FILES ---------------------------------------------
"BAR_USC_ElastoDyn_location0.28_DLC1.1_U16.dat" EDFile        - Name of file containing ElastoDyn input parameters (quoted string)
"BAR_USC_BeamDyn_location0.28_DLC1.1_U16.dat" BDBldFile(1)  - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"BAR_USC_BeamDyn_location0.28_DLC1.1_U16.dat" BDBldFile(2)  - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
"BAR_USC_BeamDyn_location0.28_DLC1.1_U16.dat" BDBldFile(3)  - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
"BAR_USC_InflowFile_location0.28_DLC1.1_U16.dat" InflowFile    - Name of file containing inflow wind input parameters (quoted string)
