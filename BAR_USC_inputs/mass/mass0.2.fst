...
---------------------- INPUT FILES ---------------------------------------------
"BAR_USC_ElastoDyn_mass0.2.dat" EDFile        - Name of file containing ElastoDyn input parameters (quoted string)
"BAR_USC_BeamDyn_mass0.2.dat" BDBldFile(1)  - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
